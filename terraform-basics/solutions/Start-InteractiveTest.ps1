...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/waynehoggett/HackathonSetup/refs/heads/main/terraform-basics/solutions/5/main.tf" -OutFile "C:\Terraform\main.tf" -UseBasicParsing
