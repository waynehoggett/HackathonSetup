...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/waynehoggett/HackathonSetup/main/terraform-advanced/hackathon.tests.ps1' -OutFile 'C:\Tests\hackathon.tests.ps1' -UseBasicParsing
## Pode Server file
